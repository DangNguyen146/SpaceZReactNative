...
import { HuyBackgroundMS, TangBackgroundMS } from "./modules/action";

const { width: WIDTH } = Dimensions.get("window");

class BackgroundMS extends Component {
  constructor(props) {
    super(props);
    this.state = {
      backgroupColor: 0,
...
const mapStateToProps = (state) => {
  return {
    data: state.listBackgroundCreateMSReducer.backgroundMS,
  };
};
const mapDispatchToProps = (dispatch) => {
  return {
    removeBackground: (object) => {
      dispatch(HuyBackgroundMS(object));
    },
...
export default connect(mapStateToProps, mapDispatchToProps)(BackgroundMS);
