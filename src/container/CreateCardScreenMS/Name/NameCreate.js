...
import { HuyNameMS, TangNameMS } from "./modules/action";

const { width: WIDTH } = Dimensions.get("window");

class NameCreateMS extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
...
const mapStateToProps = (state) => {
  return {
    data: state.listNameCreateMSReducer.nameMS,
  };
};
const mapDispatchToProps = (dispatch) => {
  return {
    removeName: (object) => {
      dispatch(HuyNameMS(object));
    },
    addName: (object) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(NameCreateMS);
