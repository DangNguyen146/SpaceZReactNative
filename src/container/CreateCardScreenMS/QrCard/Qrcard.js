...
import { HuyQrMS, TangQrMS } from "./modules/action";

const { width: WIDTH } = Dimensions.get("window");

class QrcardMS extends Component {
  constructor(props) {
    super(props);
    this.state = {
      link: "",
...
const mapStateToProps = (state) => {
  return {
    data: state.listQrCreateMSReducer.qrMS,
  };
};
const mapDispatchToProps = (dispatch) => {
  return {
    removeQr: (object) => {
      dispatch(HuyQrMS(object));
    },
    addQr: (object) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(QrcardMS);
