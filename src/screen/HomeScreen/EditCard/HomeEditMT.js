...
class HomeEditMT extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <View>
        ...
        <View style={styles.down}>
          ...
          <TouchableOpacity
            ...
            onPress={async () => {
              if (this.props.data1 !== null && this.props.data5 !== null) {
                ...
                Axios({
                  url: URL + "createcard/edit/" + this.props.data0.id,
                  headers: {
                    token: token,
                  },
                  data: data,
          ...
          <TouchableOpacity
            style={styles.contentDown}
            onPress={() => {
              this.props.navigation.navigate("EditCardMSScreen");
            }}
          >
            <Ionicons
              name="flash-sharp"
...
const mapStateToProps = (state) => {
  return {
    data0: state.listCardEditReducer.itemCard,
...
export default connect(mapStateToProps)(HomeEditMT);
